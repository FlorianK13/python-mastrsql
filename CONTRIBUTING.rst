...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/python-mastrsql.git
    cd python-mastrsql
...
#. Install |pre-commit|_::
   ...
   ``python-mastrsql`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/python-mastrsql
.. _issue tracker: https://github.com/<USERNAME>/python-mastrsql/issues
.. <-- end -->
